...
public class FTLFreightAgentGeneratorRuhr {
     ...
     */
    private void createFreightAgentWithPlan(Person freightDemandDataRelation, List<Person> freightAgents, int maxKilometerForReturnJourney) {
        ...
        for (int i = 0; i < numOfTrips; i++) {
            ...
            PopulationUtils.createAndAddActivityFromCoord(plan, "freight_end", new Coord(destinationX, destinationY));
